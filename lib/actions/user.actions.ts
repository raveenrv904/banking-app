...
export const signUp = async ({ password, ...userData }: SignUpParams) => {
  ...
  try {
    ...
    // console.log("dcustomer", dwollaCustomerUrl);
...
export const exchangePublicToken = async ({
  ...
  try {
    ...
    // Create a funding sourse URL for the account using the Dwolla customer ID, processor token and bank name
